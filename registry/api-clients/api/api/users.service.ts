...
export class UsersService {
  ...
  ): Observable<HttpResponse<Array<IdentityUser>>>;
  public allUsersGet(
    loaderType?: 'info' | 'lock' | 'default',
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<Array<IdentityUser>>>;
  public allUsersGet(
    loaderType?: 'info' | 'lock' | 'default',
    observe: any = 'body',
    ...
    let lvPath = `/AllUsers`;
    return this.httpClient.request<Array<IdentityUser>>(
      'get',
