...
export class AuthenticationService {
     ...
     */
    public apiAuthenticationDEBUGExample400Get(loaderType?: 'info' | 'lock' | 'default', observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public apiAuthenticationDEBUGExample400Get(loaderType?: 'info' | 'lock' | 'default', observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public apiAuthenticationDEBUGExample400Get(loaderType?: 'info' | 'lock' | 'default', observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public apiAuthenticationDEBUGExample400Get(loaderType?: 'info' | 'lock' | 'default', observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        ...
        let lvPath = `/api/Authentication/DEBUG_Example400`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiAuthenticationDEBUGExample500Get(loaderType?: 'info' | 'lock' | 'default', observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public apiAuthenticationDEBUGExample500Get(loaderType?: 'info' | 'lock' | 'default', observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public apiAuthenticationDEBUGExample500Get(loaderType?: 'info' | 'lock' | 'default', observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public apiAuthenticationDEBUGExample500Get(loaderType?: 'info' | 'lock' | 'default', observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        let lvHeaders = this.defaultHeaders;
        let lvHttpHeaderAcceptSelected: string | undefined = options && options.httpHeaderAccept;
        if (lvHttpHeaderAcceptSelected === undefined) {
            // to determine the Accept header
        ...
        let lvPath = `/api/Authentication/DEBUG_Example500`;
        return this.httpClient.request<any>('get', `${this.configuration.basePath}${lvPath}`,
            {
                context: lvHttpContext,
                responseType: <any>responseType_,
