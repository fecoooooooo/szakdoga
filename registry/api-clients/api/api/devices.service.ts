...
export class DevicesService {
  ...
  public apiDevicesDeviceIdGet(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling apiDevicesDeviceIdGet.'
      );
    }
    let lvHeaders = this.defaultHeaders;
    let lvHttpHeaderAcceptSelected: string | undefined =
    ...
    let lvPath = `/api/Devices/Device/${this.configuration.encodeParam({
      name: 'id',
      value: id,
      in: 'path',
      style: 'simple',
