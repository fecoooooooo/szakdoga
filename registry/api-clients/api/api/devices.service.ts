...
export class DevicesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiDevicesDeviceIdGet(id: number, loaderType?: 'info' | 'lock' | 'default', observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<Device>;
    public apiDevicesDeviceIdGet(id: number, loaderType?: 'info' | 'lock' | 'default', observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<Device>>;
    public apiDevicesDeviceIdGet(id: number, loaderType?: 'info' | 'lock' | 'default', observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<Device>>;
    public apiDevicesDeviceIdGet(id: number, loaderType?: 'info' | 'lock' | 'default', observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiDevicesDeviceIdGet.');
        }
        let lvHeaders = this.defaultHeaders;
        let lvHttpHeaderAcceptSelected: string | undefined = options && options.httpHeaderAccept;
        if (lvHttpHeaderAcceptSelected === undefined) {
        ...
        let lvPath = `/api/Devices/Device/${this.configuration.encodeParam({name: "id", value: id, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}`;
